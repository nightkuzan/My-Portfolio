...
export const th: Dict = {
  ...
  roles: {
    ...
    hlab: {
      ...
      points: [
        'CORTEX Hospital — ระบบบริหารโรงพยาบาลบนคลาวด์ เพิ่มฟีเจอร์และแก้บั๊กในโมดูล Reception ที่มีอยู่เดิม',
        'ทำระบบรายงานและการสร้างเอกสารด้วย Jasper Reports',
        'พัฒนาเซอร์วิสหลังบ้านด้วย Go และ TypeScript',
    ...
    victoryFirst: {
      ...
      points: [
        ...
        'ทำหน้าจอที่อิงแผนที่ด้วย Leaflet.js และข้อมูลอุปกรณ์แบบเรียลไทม์ผ่าน MQTT',
      ],
    },
  },
