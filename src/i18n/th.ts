  ...
  roles: {
    ...
    victory: {
      ...
      points: [
        ...
        'แพลตฟอร์มแชต omnichannel — ทำฟีเจอร์ LINE Broadcast ตั้งแต่ต้นจนจบ และแก้ไปป์ไลน์ขาเข้าจากที่ระบายคิวไม่หมดเลย ให้เคลียร์เบิร์สต์ 120 ข้อความ/วินาที นาน 2 นาที ได้ใน ~12 วินาที',
      ],
    },
    hlab: {
      title: 'Full Stack Developer',
